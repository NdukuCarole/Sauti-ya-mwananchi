          ...
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <div class="row no-gutters align-items-center">
                ...
                $connection=mysqli_connect("localhost","root","","project");
                $query = "SELECT Problemdetail FROM engagement ORDER BY id";  
                $query_run = mysqli_query($connection, $query);
                $row = mysqli_num_rows($query_run);
...
0                        ?>
                            <tr>
                                ...
                                <form action="fixissue.php" method="POST">
                                <input type="hidden" name="issue_id" value="<?php echo $row['Issue_id'];?>" style="visibility: hidden;"/>
            <button type="submit" name="edit_btn" class="btn btn-success"> Mark as fixed</button>
          </form>
                                </td>
                                <td>
                                    <form action="code.php" method="post">
                                        <input type="hidden" name="delete_id" value="<?php echo $row['id']; ?>">
                                        <button type="submit" name="delete_btn" class="btn btn-danger"> </button>
                                    </form>
                                </td>
                            </tr>
                        <?php
