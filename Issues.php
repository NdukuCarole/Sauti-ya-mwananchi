...
<head>
    ...
    <title>Issues |Sauti Ya Mwanachi</title>
...
<body>
 <?php
  ...
  if(isset($_POST['submit']))
  {
    ...
    $Issuetype=mysqli_real_escape_string($conn,$_POST['issueid']);
...
for( $i=0 ; $i < $total ; $i++ ) {
  ...
  if ($tmpFilePath != ""){
    ...
    $newFilePath = "./uploadFiles/".uniqid() . $_FILES['upload']['name'][$i];
...
$fileJson = mysqli_real_escape_string($conn, json_encode($files));
  $query= "INSERT INTO issues(issueid,title,Problemdetail,choosefile,location,fixed)
  VALUES ('$Issuetype','$title','$Problemdetail','$fileJson','$location','$fixed')";
...
<!-- sign in ribbon -->
      ...
      <section id="contact-page">
        <div class="container">
		  ...
		  <h3>How to report an issue</h3>
		   <p> 1. Enter the necessary details</P>
		   <p> 2. If you are at the location Use the get loction button</P>
		    <p>3.upload a picture if necessary </P>
		    <p> 4. submit</P>
 ...
 <div class="row">
              <form method= "post" enctype="multipart/form-data" role="form" style="background-color: #E9F5E4;">
                ...
                <label for="ad">issue-Type:</label>
                <?php include('Conn.php');
            $query = "SELECT * FROM `issues_type`";
                $result = mysqli_query($conn, $query);
                ?><select  id="property"class="form-control form-control-sm"name = "issueid">
                <option selected>Select issue-Type...</option>
                <?php while($issueid = mysqli_fetch_array($result)):;?>
                <option value="<?php echo $issueid[0];?>"><?php echo $issueid[1];?></option>
                <?php endwhile;?>
                </select>
                </div><br>
                ...
                <input name="title" type="text" class="form-control" id="title" placeholder="Title" >
				 ...
				 <div class="form-group col-md-8">
                <label for="ad">Explain the problem in detail:</label>
    ...
    <input type="file" name="upload[]" class="custom-file-input" id="chooseFile" multiple>
    <label class="custom-file-label" for="chooseFile">Select file</label>
              ...
              <div class="form-group col-md-8">
                ...
                <div class="form-group col-md-8">
                <label for="ad" ></label>
                <input name="fixed" type="hidden" class="form-control" id="fixed" placeholder="" >
                </div><br>
