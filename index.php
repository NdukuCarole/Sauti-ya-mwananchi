                        ...
                        <div class="main-menu">
                            <nav>
                                ...
                                <ul id="navigation">
                                    ...
                                    <a href="login-user.php" class="boxed-btn4" style="background:#23581c; ">Sign in
                            </a>
                            <a href="signup-user.php" class="boxed-btn4" style="background:#23581c;" >Register
                            </a>
...
<!-- sign in ribbon -->
    ...
    <svg viewbox="0 0 0 0" width="0" height="0" style="display:block;position:relative;left:0px;top:0px;">
        <defs>
            <mask id="jssor_1_msk_1">
                <image data-load="href" width="980" height="490" x="0" y="0" style="position:absolute;max-width:980px;" href="img/banner/banner.jpg"></image>
            </mask>
            <mask id="jssor_1_msk_2">
                <image data-load="href" width="980" height="490" x="0" y="0" style="position:absolute;opacity:1;max-width:980px;" href="img/banner/banner.jpg"></image>
            </mask>
    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:490px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:490px;overflow:hidden;">
            <div data-p="735">
                <img data-u="image" src="img/banner/banner.jpg" />
                <img data-t="0" style="left:0px;top:0px;width:980px;height:490px;position:absolute;opacity:0;max-width:980px;" src="img/banner/banner.jpg" />
...
<div class="slider-item">
        <div class="container" style="margin-top:150px; margin-left: 80px;">
          <div class="row slider-text align-items-center">
            <div class="col-md-30 col-sm-20 element-animate">
              <h1 style="color:fff;">Sauti Yako Inaskika</h1>
              <p> </p>
            </div>
          </div>
        </div>
            ...
            <div data-p="735">
                <img data-u="image" src="img/banner/Nairobi-County-constituencies-and-wards.jpg" />
...
<div class="slider-item">
        <div class="container" style="margin-top:150px; margin-left: 80px;">
          <div class="row slider-text align-items-center">
            ...
            <div data-p="735">
                <img data-u="image" src="img/banner/NAIROBI.jpg" />
                <div class="col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
               <div class="slider-item">
        <div class="container"  style="margin-top:150px; margin-left: 80px;">
          <div class="row slider-text align-items-center">
            <div class="col-md-30 col-sm-20 element-animate">
              <h1 style="color:#060706 "> Pamoja Tusimamiane</h1>
              <p></p>
            </div>
          </div>
        </div>
		...
		<div class="container box_1170">
			<div class="section-top-border">
				<div class="section_title text-center mb-55">
                        <h3><span>Welcome to Sauti Ya Mwananchi</span></h3>
                    </div>
				<div class="row">
					<div class="col-md-4">
					...
					<div class="col-md-8 mt-sm-20">
						<p>Citizens can now report issues affecting them directly,gain access to information directly from the county and apply for financial aid
                           from the comfort of their phones. Have direct communication with the county government and help build a better country</p>
					</div>
				</div>
			</div>
			</div>
    ...
    <div class="whole-wrap">
		<div class="container box_1170">
			<div class="section-top-border">
				<div class="section_title text-center mb-55">
                        <h3><span>Why <strong>Sauti Ya Mwananchi</strong></span></h3>
                    </div>
					<div class="col-md-24">
					<div class="row">
					...
					<div class="col-md-4">
                           <i class="fa fa-check-square"  style="font-size:48px;"></i>
                            <div class="col-md-8 mt-sm-20">
                                <h3>Convenience</h3>
                                <p>Access services at the comfort of your phone.</p>
                            </div>
                        </div>
						...
						<div class="col-md-4">
                           <i class="fa fa-mobile"  style="font-size:48px;"></i>
                            <div class="col-md-8 mt-sm-20">
                                <h3>All in one</h3>
                                <p>Access a variety of services</p>
                            </div>
                        </div>


						<div class="col-md-4">
                           <i class="fa fa-unlock-alt"  style="font-size:48px;"></i>
                            <div class="col-md-8 mt-sm-20">
                                <h3>Single Sign-On</h3>
                                <p>One account, a username and a password is all you need to get access.</p>
                            </div>
                        </div>
					</div>
					</div>
